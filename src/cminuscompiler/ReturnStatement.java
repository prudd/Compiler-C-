    ...
    public void genCode(Function func){
        if(expression != null){
            ...
            Operation assignOp = new Operation(Operation.OperationType.ASSIGN,
                                            func.getCurrBlock());
            assignOp.setSrcOperand(0, new Operand(OperandType.REGISTER, 
                                            regNum));
            assignOp.setDestOperand(0, new Operand(OperandType.MACRO, 
                                            "RetReg"));
        ...
        Operation jumpOp = new Operation(Operation.OperationType.JMP,
                                            func.getCurrBlock());
        jumpOp.setSrcOperand(0, new Operand(OperandType.BLOCK,
                                            returnBlockNum));
    }
